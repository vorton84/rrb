...
from recipe.irt.irt_trainer import IrtTrainerMixin

class RayIrtDAPOTrainer(IrtTrainerMixin, RayDAPOTrainer):
    pass
...
class TaskRunner:
    def run(self, config):
        ...
        if config.actor_rollout_ref.actor.strategy in {"fsdp", "fsdp2"}:
            ...
            raise NotImplementedError("IRT recipe is wired for the FSDP worker only")
