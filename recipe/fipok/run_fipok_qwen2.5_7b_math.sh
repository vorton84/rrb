...
project_name='FIPO'
exp_name='FIPO-K-Qwen2.5-Math-7B'
...
python3 -m recipe.fipok.main_fipok \
    ...
    +actor_rollout_ref.actor.policy_loss.var_window=${var_window} \
    +actor_rollout_ref.actor.policy_loss.gamma_min=${gamma_min} \
    +actor_rollout_ref.actor.policy_loss.gamma_max=${gamma_max} \
